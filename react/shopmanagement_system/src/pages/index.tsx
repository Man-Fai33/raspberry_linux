                ...
                personalProfileDisplay ?
                    <>
                        <div className=" relative h-dvh w-full bg-scroll grid grid-cols-6 gap-4    max-lg:grid-cols-1  max-lg:gap-0   justify-self-center " >
                            <div className='relative col-span-4 flex p-72   max-xl:p-40 max-lg:p-20 max-md:p-0 bg-slate-500 '
                            // style={{ backgroundImage: `url(${backgroundImage})` }}
                            >
                                        ...
                                        <div className='text-base text-left font-sans tracking-normal text-ellipsis max-lg:text-sm'>
                                            <List>
                                                ...
                                                <div className='flex flex-row'>
                                                    ...
                                                    <ListItemText className='text-xl max-lg:text-md max-md:text-sm tracking-wide text-justify' primary="香港教師會李興貴中學" />
                                                </div>
                                            </List>
                                        </div>
                                    </div>
                            ...
                            <div className='h-dvh w-full bg-slate-400 p-5 max-md:p-2 space-y-4  overflow-hidden'>
                                ...
                                <div className='relative  flex justify-center content-center items-center h-full  overflow-x-auto pt-10 pb-10'>
                                    <div className='flex flex-nowrap relative  w-full gap-5'>
                                        <ProjectCard photo={''} info={''} link={''} onclick={() => { setModaldisable(true); }} />
                                        <ProjectCard photo={''} info={''} link={''} onclick={() => { setModaldisable(true); }} />
                                        <ProjectCard photo={''} info={''} link={''} onclick={() => { setModaldisable(true); }} />
                                        <ProjectCard photo={''} info={''} link={''} onclick={() => { setModaldisable(true); }} />
                                        <ProjectCard photo={''} info={''} link={''} onclick={() => { setModaldisable(true); }} />
                                    </div>
                                    <SkillModal link={''} disable={modaldisable} onclick={() => { setModaldisable(!modaldisable) }} />
                                </div>
